...
export const metadata: Metadata = {
  ...
  title: {
    default:
      'Juliskin | Cosmetología Premium - Tratamientos Faciales y Corporales',
  ...
  openGraph: {
    ...
    description:
      'Tratamientos especializados y cursos profesionales de estética. Tecnología avanzada y resultados comprobados.',
    type: 'website',
    siteName: 'Juliskin',
    locale: 'es_CO',
  },
