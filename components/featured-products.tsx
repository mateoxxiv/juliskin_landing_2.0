...
const products = [
  {
    ...
    description: "Fórmula avanzada con vitamina C y ácido hialurónico para una piel luminosa",
  },
  {
    id: 2,
    ...
    description: "Regeneración celular profunda mientras duermes con péptidos activos",
  },
  {
    id: 3,
    ...
    description: "Detoxifica y purifica con arcillas minerales y extractos botánicos",
  },
  {
    id: 4,
    ...
    description: "Reduce líneas de expresión y ojeras con cafeína y retinol suave",
  },
]
    ...
    <section id="productos" className="py-16 md:py-24 lg:py-32 bg-background">
      <div className="container mx-auto px-4 md:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 md:mb-16">
          <p className="text-sm tracking-[0.3em] uppercase text-muted-foreground mb-4">Los más deseados</p>
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto leading-relaxed text-pretty">
            Descubre nuestra selección premium de productos científicamente formulados para transformar tu piel
          </p>
        </div>
