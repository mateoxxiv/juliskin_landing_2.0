...
export const services: Service[] = [
  ...
  },
  {
    ...
    ideal: [
      ...
      'Puntos negros ó tendencia a acné',
  ...
  },
  {
    ...
    shortDescription:
      'Tratamiento adaptado a las necesidades específicas de tu piel',
    description:
  ...
  },
  {
    ...
    shortDescription:
      'Exfoliación y renovación avanzada que suaviza e ilumina la piel',
    description:
  ...
  },
  {
    ...
    ideal: [
      ...
      'Piel con puntos negros y marcas de acné',
    ],
    process: [
      'Preparación de piel',
      'Toalla caliente',
  ...
  },
  {
    ...
    ideal: [
      'Personas con poca grasa localizada',
      'Marcación de músculos',
      'Mantenimiento',
  ...
  },
  {
    ...
    benefits: [
      'Cambios significativos en reducción de medidas',
      'Combate celulitis',
      'Drenaje de líquidos',
      'Moldeo abdomen y cintura',
    ],
    includes: [
  ...
  // CURSOS Y TALLERES
  {
    ...
    shortDescription:
      'Aprende varios tipos de limpieza facial para todas las pieles',
    description:
    ...
    process: [
      'Teoría fundamental de fisiología y anatomía de la piel',
      'Protocolo completo de limpieza facial perfeccionado por Juli Skin ® ',
  ...
  },
  {
    ...
    shortDescription:
      'Domina la técnica de Dermapen para cicatrices y rejuvenecimiento',
    description:
    ...
    process: [
      'Teoría fundamental de fisiología y anatomía de la piel',
      'Protocolo completo de microagujamiento perfeccionado por Juli Skin ®',
...

  {
    ...
    shortDescription:
      'Técnicas manuales para tratamientos faciales y corporales',
    description:
    ...
    process: [
      'Teoría anatómica y fisiológica completa de sistema linfático y circulatorio',
      'Maniobras avanzadas y actualizadas de drenaje linfático manual',
...

  {
    ...
    process: [
      ...
      'Teoría fundamental de fisiología y anatomía de la piel con acné',
      'Protocolo completo de tratamiento avanzado del acné perfeccionado por Juli Skin ®',
      'Plan de tratamiento',
      'rutinas para todo tipo de acné',
      'Recomendaciones de alimentación y estilo de vida',
      'Practica en usuarios',
      'Seguimiento',
    ],
  },
  {
    ...
    process: [
      'Evaluación',
      'Teoría fundamental de fisiología y anatomía de la piel hiperpigmentada',
      'Protocolo completo de tratamiento avanzado del manchas perfeccionado por Juli Skin ®',
  ...
  },
  {
    ...
    ideal: [
      'Secuelas severas',
      'Profesionales que deseen realizar tratamientos avanzados y actualizados',
    ],
    process: [
      'Evaluación de tejido',
      'Teoría fundamental de fisiología y anatomía de la cicatriz',
      'Protocolo completo de tratamiento avanzado de cicatrices atróficas perfeccionado por Juli Skin ®',
      'Plan combinado',
      'Regeneración',
    ],
  },
  {
    ...
    process: [
      ...
      'Teoría fundamental de fisiología y anatomía del área periocular',
      'Protocolo completo de tratamiento avanzado de ojeras y bolsas perfeccionado por Juli Skin ®',
      'Técnica combinada',
      'Cuidados delicados',
    ],
  },
  {
    ...
    process: [
      'Teoria completa de limpieza, desinfección y esterilización de herramientas cosmetologicas',
      'Recomendaciones de cuidado para herramientas y equipos',
...
export function getCategoryInfo(slug: string) {
  const categories = {
    faciales: {
      ...
      longDescription:
        'Nuestros tratamientos faciales están diseñados para abordar las necesidades específicas de tu piel. Desde limpiezas profundas hasta protocolos anti-edad avanzados, cada servicio combina técnicas manuales expertas con tecnología de vanguardia y productos premium.',
      image: 'https://i.ibb.co/yns7hf2x/tratamientos-faciales.jpg',
    },
    capilares: {
      ...
      longDescription:
        'Transforma tu cabello con nuestros tratamientos especializados. Desde alisados con keratina hasta reparaciones intensivas con botox capilar, ofrecemos soluciones personalizadas para cada tipo de cabello y necesidad.',
      image: 'https://i.ibb.co/yns7hf2x/tratamientos-faciales.jpg',
    },
    corporales: {
      ...
      longDescription:
        'Descubre el equilibrio perfecto entre relajación y resultados. Nuestros tratamientos corporales combinan masajes terapéuticos, tecnología avanzada y productos naturales para brindarte una experiencia de bienestar completa.',
      image: 'https://i.ibb.co/yns7hf2x/tratamientos-faciales.jpg',
    },
    cursos: {
      name: 'Cursos y Talleres',
      description:
        'Capacitaciones avanzadas para profesionales de la estética.',
      longDescription:
        'Nuestros cursos están diseñados para empoderarte con el conocimiento y las técnicas necesarias para un cuidado personal experto. Desde automaquillaje hasta rutinas de skincare avanzadas, aprende de la mano de profesionales.',
      image: 'https://i.ibb.co/yns7hf2x/tratamientos-faciales.jpg',
    },
  }
